...
#  2. Do some random image transformations to increase the number of training samples and load the trainand test data
...
filepath = 'dermatology_fine_tuned_model.h5'
